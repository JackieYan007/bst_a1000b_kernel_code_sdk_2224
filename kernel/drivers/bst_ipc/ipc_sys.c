			 ...
			 const char *buf, size_t count)
{
	...
	printk("%-11s%-4s%-4s%-9s%-9s%-13s%-16s%-7s%-11s%-13s%-16s%-8s%-12s\n", 
	...
	printk("%-11d%-4d%-4d%-9d%-9d%-13d%-16d%-7d%-11d%-13d%-16d%-8d%-12d\n",
...
//subsys_initcall(core_addr_init);
//module_exit(core_addr_exit);
//MODULE_LICENSE("GPL v2");
//MODULE_AUTHOR("Wenjian.gou <wenjian.gou@bst.ai>");
